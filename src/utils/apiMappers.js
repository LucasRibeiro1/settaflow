...
export function mapCliente(raw) {
  ...
  return {
    ...
    telefoneFinanceiro: String(raw.TELCONT ?? raw.TELFINANCEIRO ?? raw.telfinanceiro ?? '').trim(),
    emailFinanceiro: String(raw.EMAILCONT ?? raw.EMAILFINANCEIRO ?? raw.emailfinanceiro ?? '').trim(),
